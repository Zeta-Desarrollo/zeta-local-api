...
galleriesRouter.post("/updateGalleryImage", devFunction, isAuth, checkPermissions(["editar-galeria"]), callController(controller.updateGalleryImage))
...
galleriesRouter.post("/uploadFile", devFunction, isAuth, checkPermissions(["editar-galeria"]), callController(controller.uploadFile))
galleriesRouter.post("/setFilePages", devFunction, isAuth, checkPermissions(["editar-galeria"]), callController(controller.setFilePages))
...
galleriesRouter.get("/getGallery", devFunction, isAuth, checkPermissions(["ver-galeria"]), callController(controller.getGallery))
