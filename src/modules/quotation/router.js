...
quotationRouter.get("/price-lists",devFunction, isAuth, callController(controller.getPriceLists))
quotationRouter.get("/defaultPriceList",devFunction, callController(controller.getDefaultPriceList))
